...
namespace Mozo.Comun.Implement.ImageResizer
{
    ...
    public partial class ImageResizerMiddleware
    {
        ...
        public ImageResizerMiddleware(RequestDelegate next, IWebHostEnvironment env,  IMemoryCache memoryCache)
        {
            _next = next;
            _env = env;
           // _logger = logger;
        ...
        public async Task Procesar(HttpContext context, PathString path)
        {
            //
