...
public interface IHttpClientCondominio : IHttpClientGeneric
{
    // Task<SelectList> Local_GetAll();
}

public class HttpClientCondominio : IHttpClientCondominio
{
    private readonly IMemoryCache _cache;
    private readonly HttpClient _client;
    private readonly ConfigurationModel _configuration;

    public HttpClientCondominio(HttpClient client, IMemoryCache cache, IOptions<ConfigurationModel> configuration)
    {
        _client = client;
        _cache = cache;
