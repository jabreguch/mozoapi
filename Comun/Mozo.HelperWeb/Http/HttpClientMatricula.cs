...
public interface IHttpClientMatricula : IHttpClientGeneric
{
    // Task<SelectList> Local_GetAll();
}

public class HttpClientMatricula : IHttpClientMatricula
{
    private readonly IMemoryCache _cache;
    private readonly HttpClient _client;
    private readonly ConfigurationModel _configuration;

    public HttpClientMatricula(HttpClient client, IMemoryCache cache, IOptions<ConfigurationModel> configuration)
    {
        _client = client;
        _cache = cache;
