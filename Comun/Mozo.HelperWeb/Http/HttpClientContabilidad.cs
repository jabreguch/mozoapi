...
public interface IHttpClientContabilidad : IHttpClientGeneric
{

}

public class HttpClientContabilidad : IHttpClientContabilidad
{
    private readonly IMemoryCache _cache;
    private readonly HttpClient _client;
    private readonly ConfigurationModel _configuration;

    public HttpClientContabilidad(HttpClient client, IMemoryCache cache, IOptions<ConfigurationModel> configuration)
    {
        _client = client;
        _cache = cache;
