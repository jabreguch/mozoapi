...
public interface IHttpClientCompra : IHttpClientGeneric
{

}

public class HttpClientCompra : IHttpClientCompra
{
    private readonly IMemoryCache _cache;
    private readonly HttpClient _client;
    private readonly ConfigurationModel _configuration;

    public HttpClientCompra(HttpClient client, IMemoryCache cache, IOptions<ConfigurationModel> configuration)
    {
        _client = client;
        _cache = cache;
