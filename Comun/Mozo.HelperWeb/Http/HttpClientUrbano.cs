...
public interface IHttpClientUrbano : IHttpClientGeneric
{
    //Task<SelectList> Inventario_Almacen_GetAll(ArticuloStockModel c, string CoAlmacen=null);
}

public class HttpClientUrbano : IHttpClientUrbano
{
    private readonly IMemoryCache _cache;
    private readonly HttpClient _client;
    private readonly ConfigurationModel _configuration;

    public HttpClientUrbano(HttpClient client, IMemoryCache cache, IOptions<ConfigurationModel> configuration)
    {
        _client = client;
        _cache = cache;
